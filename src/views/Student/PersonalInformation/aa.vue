  ...
  <div class="xgmm1Box1">
    ...
    <div class="xgmm1Box">
      ...
      <div style="margin-bottom: 50px;">
        ...
        <el-input placeholder="请输入密码" v-model="input2" show-password style="width: 400px;margin-left: -25px;"></el-input>
      </div>
      <div style="margin-right: 30px;">
        <label for="请输入原密码" style="margin-right: 50px;"><span class="xing">*</span>请再次输入修改密码:</label>
        <el-input placeholder="请输入密码" v-model="input3" show-password style="width: 400px;margin-left: -45px;"></el-input>
      </div>
...
export default {
  ...
  methods: {
    updatePassword(){
      axios.get("/main/updatePassword",{params:{
        password:this.input1,
        newPassword:this.input2,
        isNewPassword:this.input3
      }})
    },
    open() {
            if (this.input1 != '') {
