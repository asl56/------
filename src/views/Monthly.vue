  ...
  <div>
      ...
      <div class="forth2" style="
        ...
        <div class="lndivt" style="background-color: #f2f6fc">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item :to="{ path: '/main/operations' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item
              :to="{ path: '/main/shiXiAndJiuYe?className=' + this.className }">实习就业</el-breadcrumb-item>
    ...
    <el-dialog :title="dialogData.monthlyReportTitle" :visible.sync="centerDialogVisible" width="30%" center>
      <span>{{ dialogData.monthlyReportDetails }}</span><br>
        ...
        <label  v-if="dialogData.score<0" >打分：<el-input v-model="score"  placeholder="暂未评分" style="width: 100px;">{{ 0 }}</el-input></label>
